...
interface BestSellersPageClientProps {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
        ...
        {/* Page Header */}
        <div className="bg-gradient-to-r from-yellow-400 to-amber-500 rounded-lg shadow-lg p-6 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              <h1 className="text-2xl md:text-3xl font-bold">Best Sellers</h1>
              <p className="text-white/80 mt-1">
                {meta ? `${meta.total} top-selling products` : 'Loading products...'}
              </p>
            </div>
          </div>
        </div>
              ...
              >
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 bg-amber-500 text-white rounded-lg text-sm hover:bg-amber-600"
                  >
                    Apply
                  </button>
                </div>
                  ...
                  {brands.map((brand) => (
                    <label key={brand.id} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-amber-500 focus:ring-amber-500 rounded border-gray-300"
                      />
          ...
          <div className="flex-1">
            ...
            {products.length === 0 ? (
              <div className="bg-white rounded-lg shadow-sm p-12 text-center">
                ...
                <p className="text-gray-600 mb-4">Check back soon for top products!</p>
                <button
                  onClick={clearFilters}
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-full max-w-sm bg-white shadow-xl overflow-y-auto">
            ...
            <div className="p-4 border-t border-gray-200 sticky bottom-0 bg-white">
              <button
                onClick={() => setShowMobileFilters(false)}
                className="w-full px-4 py-3 bg-amber-500 text-white rounded-lg font-medium hover:bg-amber-600"
              >
                Apply Filters
              </button>
            </div>
