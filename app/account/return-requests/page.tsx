      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 bg-gradient-to-br from-rose-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg shadow-rose-500/25">
            <FiRefreshCw className="text-white" size={26} />
          </div>
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Return Requests</h1>
            <p className="text-gray-500 text-sm mt-0.5">Manage your product returns and refunds</p>
          </div>
        </div>
        <Link
          href="/account/return-requests/new"
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 text-white rounded-xl font-semibold text-sm transition-all duration-200 shadow-lg shadow-rose-500/25 hover:shadow-xl"
        >
          New Request
