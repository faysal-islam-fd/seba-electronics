        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">Service Requests</h1>
                <p className="text-sm text-gray-600 mt-1">Manage your warranty and repair requests</p>
              </div>
            </div>
          </div>
